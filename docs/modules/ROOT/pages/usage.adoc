...
For more details on how to specify resources in general for products running on the Stackable Data Platform see: xref:concepts:resources.adoc[Resource management].
