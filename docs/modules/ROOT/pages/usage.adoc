...
These are written in-line in the python code below, though this is just to make it clear how the code is used (since these classes will be used for any and all custom resources that would be external to but in the same folder as the DAG files):
