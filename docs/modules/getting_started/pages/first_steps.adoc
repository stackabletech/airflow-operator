...
Once you have followed the steps in the xref:installation.adoc[] section to install the Operator and its dependencies, you will now deploy a Airflow cluster and its dependencies. Afterwards you can <<_verify_that_it_works, verify that it works>> by running and tracking an example DAG.
...
[source,bash]
include::example$code/getting_started.sh[tag=apply-airflow-credentials]
...
----
include::example$code/getting_started.sh[tag=install-airflow]
----
...
[source,bash]
include::example$code/getting_started.sh[tag=enable-dag]
...
[source,bash]
include::example$code/getting_started.sh[tag=run-dag]
...
[source,bash]
include::example$code/getting_started.sh[tag=check-dag]
====
