...
== Prerequisites: Postgresql and Redis
...
WARN: Do not use this setup in production! Supported databases and versions are listed on the xref:prerequisites.adoc[prerequisites] page for this Operator. Please follow the database and Redis instructions for a production setup.
