...
chmod +x "docs/modules/airflow-operator/examples/getting_started/getting_started.sh" \
  || chmod +x "docs/modules/airflow-operator/examples/getting_started/code/getting_started.sh" \
  || true
