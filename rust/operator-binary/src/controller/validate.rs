...
use stackable_operator::{
    ...
    k8s_openapi::{
        DeepMerge,
        api::core::v1::{
            ConfigMap, Container as K8sContainer, PodTemplateSpec, Volume, VolumeMount,
        },
    },
    kube::{
...
use stackable_operator::builder::pod::volume::{ListenerOperatorVolumeSourceBuilder, ListenerReference};
...
type ValidateResult<T> = std::result::Result<T, Error>;
...
pub(crate) fn validate_airflow_config(
