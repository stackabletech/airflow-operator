...
//!
//! Takes `KubernetesResources<Prepared>` and applies them to the cluster,
//! producing `KubernetesResources<Applied>`.
...
use stackable_operator::{
    client::Client,
    cluster_resources::{ClusterResource, ClusterResources},
};
...
impl<'a> Applier<'a> {
    pub fn new(client: &'a Client, cluster_resources: ClusterResources<'a>) -> Self {
        Applier {
            client,
            cluster_resources,
        }
