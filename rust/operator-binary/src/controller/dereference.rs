//! The dereference step in the AirflowCluster controller
//!
//! Fetches and resolves all external resources referenced by the AirflowCluster spec:
//! product image, authentication classes, authorization config, and internal secrets.

use snafu::{ResultExt, Snafu};
use stackable_operator::{
    client::Client,
    commons::{product_image_selection::ResolvedProductImage, random_secret_creation},
};
