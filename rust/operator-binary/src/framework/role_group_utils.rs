...
mod tests {
    ...
    fn test_resource_names() {
        ...
        let resource_names = ResourceNames {
            ...
            role_name: RoleName::from_str_unsafe("webserver"),
            role_group_name: RoleGroupName::from_str_unsafe("default"),
        };

        assert_eq!(
            QualifiedRoleGroupName::from_str_unsafe("test-cluster-webserver-default"),
            resource_names.qualified_role_group_name()
        );
        assert_eq!(
            ConfigMapName::from_str_unsafe("test-cluster-webserver-default"),
            resource_names.role_group_config_map()
        );
        assert_eq!(
            StatefulSetName::from_str_unsafe("test-cluster-webserver-default"),
            resource_names.stateful_set_name()
        );
        assert_eq!(
            ServiceName::from_str_unsafe("test-cluster-webserver-default-headless"),
            resource_names.headless_service_name()
        );
        assert_eq!(
            ListenerName::from_str_unsafe("test-cluster-webserver-default"),
