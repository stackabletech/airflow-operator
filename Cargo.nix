...
rec {
  ...
  workspaceMembers = {
    "stackable-airflow-crd" = rec {
      packageId = "stackable-airflow-crd";
    ...
    "stackable-airflow-operator" = rec {
      packageId = "stackable-airflow-operator";
      build = internal.buildRustCrateWithFeatures {
        packageId = "stackable-airflow-operator";
      };
    ...
    crates = {
      ...
      "stackable-operator" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "76e6c8bea66824a904dc41101e1606fa965d7c09";
          sha256 = "04bp2bfa02sl2nlcw76rh6747ixcf9rx0m3armk8i3m44pxdv3jh";
        };
